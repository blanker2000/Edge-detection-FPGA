...
--               d:/workshop_vivado/final_embedded/design_1/ip/design_1_axi_mem_intercon_imp_xbar_0/design_1_axi_mem_intercon_imp_xbar_0_stub.vhdl
...
entity design_1_axi_mem_intercon_imp_xbar_0 is
  ...
  attribute CORE_GENERATION_INFO of design_1_axi_mem_intercon_imp_xbar_0 : entity is "design_1_axi_mem_intercon_imp_xbar_0,axi_crossbar_v2_1_38_axi_crossbar,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_crossbar,x_ipVersion=2.1,x_ipCoreRevision=38,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_NUM_SLAVE_SLOTS=4,C_NUM_MASTER_SLOTS=1,C_AXI_ID_WIDTH=2,C_AXI_ADDR_WIDTH=32,C_AXI_DATA_WIDTH=64,C_AXI_PROTOCOL=0,C_NUM_ADDR_RANGES=1,C_M_AXI_BASE_ADDR=0x0000000000000000,C_M_AXI_ADDR_WIDTH=0x0000001d,C_S_AXI_BASE_ID=0x00000003000000020000000100000000,C_S_AXI_THREAD_ID_WIDTH=0x00000000000000000000000000000000,C_AXI_SUPPORTS_USER_SIGNALS=0,C_AXI_AWUSER_WIDTH=1,C_AXI_ARUSER_WIDTH=1,C_AXI_WUSER_WIDTH=1,C_AXI_RUSER_WIDTH=1,C_AXI_BUSER_WIDTH=1,C_M_AXI_WRITE_CONNECTIVITY=0x0000000a,C_M_AXI_READ_CONNECTIVITY=0x0000000d,C_R_REGISTER=0,C_S_AXI_SINGLE_THREAD=0x00000000000000000000000000000000,C_S_AXI_WRITE_ACCEPTANCE=0x00000002000000020000001000000002,C_S_AXI_READ_ACCEPTANCE=0x00000002000000020000000200000010,C_M_AXI_WRITE_ISSUING=0x00000008,C_M_AXI_READ_ISSUING=0x00000008,C_S_AXI_ARB_PRIORITY=0x00000000000000000000000000000000,C_M_AXI_SECURE=0x00000000,C_CONNECTIVITY_MODE=1}";
