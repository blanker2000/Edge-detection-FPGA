...
//               d:/workshop_vivado/final_embedded/design_1/ip/design_1_rgb2dvi_0_1/design_1_rgb2dvi_0_1_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_rgb2dvi_0_1,rgb2dvi,{}" *) (* downgradeipidentifiedwarnings = "yes" *) (* x_core_info = "rgb2dvi,Vivado 2025.2" *) 
...
/* synthesis syn_force_seq_prim="PixelClk" */;
  ...
  (* x_interface_info = "xilinx.com:signal:clock:1.0 PixelClk CLK" *) (* x_interface_mode = "slave PixelClk" *) (* x_interface_parameter = "XIL_INTERFACENAME PixelClk, FREQ_HZ 25000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0" *) input PixelClk /* synthesis syn_isclock = 1 */;
endmodule
